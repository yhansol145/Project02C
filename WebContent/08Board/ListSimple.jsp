...
<body>
	...
	<div class="container">
		...
		<form method="get"
			style="display: table; margin-right: auto; margin-left: auto; margin-bottom: 50px;">
			<table width="70%">
				<tr align="center">
		...
		<!-- 목록 출력을 위한 테이블 -->
		<table class="table table-striped" border="5" width="70%"
			style="display: table; margin-right: auto; margin-left: auto; text-align: center">
			<tr>
				<th width="10%">번호</th>
				<th width="50%">제목</th>
				<th width="15%">작성자</th>
		...
		<table class="table table-striped" border="5" width="70%"
			...
			<tr align="center">
				<td><%=BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, request.getRequestURI(), queryStr)%></td>
